...
SEED = [
    ...
    # ---- C14 新增热门场内 ETF（扩至 50 支内；category 即所属板块简写） ----
    # 宽基/规模
    ("159919", "沪深300ETF", "000300", [], "宽基", "场内"),
    ("510330", "沪深300ETF", "000300", [], "宽基", "场内"),
    ("159901", "深证100ETF", "399001", [], "宽基", "场内"),
    ("159949", "创业板50ETF", "399006", [], "宽基", "场内"),
    ("588080", "科创50ETF", "000688", [], "宽基", "场内"),
    ("512100", "中证1000ETF", "000905", [], "宽基", "场内"),
    ("159845", "中证1000ETF", "000905", [], "宽基", "场内"),
    ("510180", "上证180ETF", "000001", [], "宽基", "场内"),
    ("510880", "红利ETF", "000001", [], "红利", "场内"),
    ("510760", "上证综指ETF", "000001", [], "宽基", "场内"),
    # 行业/主题（部分映射 BK 板块代码，供板块趋势/资金流关联）
    ("512480", "半导体ETF", "000300", ["BK1036"], "半导体", "场内"),
    ("159995", "芯片ETF", "000300", ["BK1036"], "半导体", "场内"),
    ("515880", "通信ETF", "000300", ["BK0999"], "通信", "场内"),
    ("516970", "基建50ETF", "000300", [], "基建", "场内"),
    ("159992", "创新药ETF", "000300", ["BK0465"], "医药", "场内"),
    ("512170", "医疗ETF", "000300", ["BK0465"], "医药", "场内"),
    ("512400", "有色金属ETF", "000300", [], "有色", "场内"),
    ("515220", "煤炭ETF", "000300", [], "煤炭", "场内"),
    ("159870", "化工ETF", "000300", [], "化工", "场内"),
    ("516150", "稀土ETF", "000300", [], "稀土", "场内"),
    ("512980", "传媒ETF", "000300", [], "传媒", "场内"),
    ("159865", "养殖ETF", "000300", [], "农业", "场内"),
    ("515250", "智能汽车ETF", "000300", ["BK0900"], "智能汽车", "场内"),
    ("518880", "黄金ETF", "000300", [], "黄金", "场内"),
    # 跨境（追踪境外指数，A股场内交易）
    ("513050", "中概互联网ETF", "000300", [], "中概", "场内"),
    ("513180", "恒生科技ETF", "000300", [], "港股", "场内"),
    ("513100", "纳指ETF", "000300", [], "美股", "场内"),
    ("159941", "纳指ETF", "000300", [], "美股", "场内"),
    ("159740", "恒生科技ETF", "000300", [], "港股", "场内"),
    # 场外联接基金（示例，用于区分场内/场外）
