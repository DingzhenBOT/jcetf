...
SEED = [
    ...
    ("159915", "创业板ETF", "399006", [], "宽基"),
    ("588000", "科创50ETF", "000688", [], "宽基"),
    ("512010", "医药ETF", "000300", ["BK0465"], "医药"),
    ("512660", "军工ETF", "000300", ["BK0481"], "军工"),
    ("515030", "新能源车ETF", "000300", ["BK0900"], "新能源车"),
    ("512760", "芯片ETF", "000300", ["BK1036"], "半导体"),
    ("515050", "5G ETF", "000300", ["BK0999"], "5G"),
    ("512000", "券商ETF", "000300", ["BK0473"], "证券"),
    ("512800", "银行ETF", "000300", ["BK0475"], "银行"),
    ("159928", "消费ETF", "000300", ["BK0438"], "消费"),
    ("512690", "酒ETF", "000300", ["BK0471"], "白酒"),
    ("515790", "光伏ETF", "000300", ["BK1035"], "光伏"),
    ("512880", "证券ETF", "000300", ["BK0473"], "证券"),
]
...
def main() -> int:
    ...
    with session_scope(eng) as session:
        for code, name, idx, sectors, cat in SEED:
